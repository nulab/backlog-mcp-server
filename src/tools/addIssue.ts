...
const addIssueSchema = buildToolSchema((t) => ({
  ...
  description: z
    ...
    .optional()
    .describe(
      t('TOOL_ADD_ISSUE_DESCRIPTION', 'Detailed description of the issue. This is the primary field for explaining the issue context, requirements, and acceptance criteria. Prefer this over adding a comment.')
    ),
  startDate: z
    .string()
    .optional()
